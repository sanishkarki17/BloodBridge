      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-gradient-to-r from-primary-blue to-primary-blue-dark text-white rounded-card p-8 mb-8 shadow-medical">
          ...
          <p className="text-blue-100 mb-4">
            Connect donors with recipients across Nepal
          </p>
          {!isAuthenticated && (
        ...
        {activeTab === "donors" ? (
          <div>
            <div className="flex items-center justify-between mb-6">
              ...
              <p className="text-sm text-text-secondary">
                {donors.filter((d) => d.available).length} donors currently
                available
              </p>
            </div>
      ...
      >
        <form onSubmit={handleCreateRequest} className="space-y-4">
          <Input
            ...
            onChange={(e) =>
              setRequestFormData({ ...requestFormData, name: e.target.value })
            }
            placeholder="Sanish Karki"
            required
          />
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <Input
              ...
              onChange={(e) =>
                setRequestFormData({ ...requestFormData, city: e.target.value })
              }
          ...
          <Input
            ...
            onChange={(e) =>
              setRequestFormData({ ...requestFormData, phone: e.target.value })
            }
      ...
      <footer className="bg-white border-t border-gray-200 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <p className="text-center text-sm text-text-secondary">
            © 2025 BloodBridge Nepal • Hospital-Grade Blood Donation Management
            System
          </p>
        </div>
      </footer>
