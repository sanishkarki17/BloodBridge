                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <button
                                ...
                                className={`p-4 border-2 rounded-lg transition-all ${formData.role === 'donor'
                                    ? 'border-primary-blue bg-accent-blue-tint'
                                    : 'border-gray-200 hover:border-gray-300'
                                    }`}
                            >
                                <div className="flex flex-col items-center">
                                    <Badge variant="donor" className="mb-2">Donor</Badge>
                                    <p className="text-sm text-text-secondary">I want to donate blood</p>
                                </div>
                            </button>
                            <button
                                type="button"
                                onClick={() => setFormData({ ...formData, role: 'recipient' })}
                                className={`p-4 border-2 rounded-lg transition-all ${formData.role === 'recipient'
                                    ? 'border-primary-red bg-accent-red-tint'
                                    : 'border-gray-200 hover:border-gray-300'
                                    }`}
                            >
                                <div className="flex flex-col items-center">
                                    <Badge variant="recipient" className="mb-2">Recipient</Badge>
                    ...
                    {formData.role === 'donor' && (
                        <div className="p-4 bg-accent-blue-tint border border-primary-blue-light rounded-lg">
                            <h3 className="font-semibold text-text mb-4">Donor Information</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
